...
namespace Sacks.DataAccess.Repositories.Interfaces
{
    ...
    public interface ITransactionalProductsRepository
    {
        ...
        /// </summary>
        Task<Dictionary<string, Product>> GetByEANsBulkAsync(IEnumerable<string> eans, CancellationToken cancellationToken = default);
        ...
        void Add(Product product, string? createdBy = null);
        ...
        void AddRange(IEnumerable<Product> products, string? createdBy = null);
        ...
        void Update(Product product, string? modifiedBy = null);
        ...
        void UpdateRange(IEnumerable<Product> products, string? modifiedBy = null);
        ...
        /// </summary>
        Task<IEnumerable<Product>> GetPagedAsync(int skip, int take, CancellationToken cancellationToken = default);

        /// <summary>
        /// Finds products matching a predicate
        /// </summary>
        Task<IEnumerable<Product>> FindAsync(System.Linq.Expressions.Expression<Func<Product, bool>> predicate, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<IEnumerable<Product>> GetBySourceFileAsync(string sourceFile, CancellationToken cancellationToken = default);
        ...
        /// </summary>
        Task<IEnumerable<Product>> GetByCreatedDateRangeAsync(DateTime startDate, DateTime endDate, CancellationToken cancellationToken = default);
