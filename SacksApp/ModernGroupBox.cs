...
public class ModernGroupBox : GroupBox
{
    ...
    private void UpdateStyleFromSkin(SkinDefinition? skin = null)
    {
        ...
        {
            // Fallback to palette if no specific control style
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        // Define border rectangle (pushed down by half text height)
        ...
        // Draw text background (to clear border behind text)
        // We need the effective parent background color to "erase" the border line behind the text
